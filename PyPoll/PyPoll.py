...
import pandas as pd
import numpy as np
election_file = "desktop/school/gt-data/homework/03-python/instructions/PyPoll/Resources/election_data.csv"
election_read = pd.read_csv(election_file)
election_read.head(10)
